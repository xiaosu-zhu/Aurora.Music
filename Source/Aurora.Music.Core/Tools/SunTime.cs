/// From https://github.com/Mursaat/SunriseSunset
...
namespace Aurora.Music.Core.Tools
{
    public sealed class Sunriset
    {
        ...
        /// <param name="lat">The latitude</param>
        /// <param name="lng">The longitude</param>
        /// <returns name="tsunrise">The computed sunrise time (in hours UT)</param>
        /// <returns name="tsunset">The computed sunset time (in hours UT)</param>
        public static (TimeSpan tsunrise, TimeSpan tsunset) SunriseSunset(DateTime time, (double lng, double lat) pos)
        {
            SunriseSunset(time.Year, time.Month, time.Day, pos.lng, pos.lat, SunriseSunsetAltitude, true, out var tsunrise, out var tsunset);
            var offset = DateTime.UtcNow - DateTime.Now;
            return (TimeSpan.FromHours(tsunrise) - offset, TimeSpan.FromHours(tsunset) - offset);
        }
