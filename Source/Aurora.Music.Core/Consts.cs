...
namespace Aurora.Music.Core
{
    ...
    public static class Consts
    {
        ...
        public static string UpdateNote =>
                            ...
                            "* **Improve**: Merged pull requests [#7](https://github.com/pkzxs/Aurora.Music/pull/7), [#9](https://github.com/pkzxs/Aurora.Music/pull/9) contributed by [OpportunityLiu](https://github.com/OpportunityLiu):\r\n\r\n" +
                            "* **Improve**: Now can delete search histories.\r\n" +
                            "* **Improve**: Mojibake fixed.\r\n" +
                            "* **Improve**: Now can view a podcast from older to newer.\r\n" +
                            "* **Improve**: Fixed duplicate artists.\r\n" +
