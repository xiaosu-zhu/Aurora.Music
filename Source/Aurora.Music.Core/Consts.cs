...
namespace Aurora.Music.Core
{
    ...
    public static class Consts
    {
        ...
        public static string UpdateNote =>
                            ...
                            "* **Improve**: Merged pull requests [#4](https://github.com/pkzxs/Aurora.Music/pull/4), [#5](https://github.com/pkzxs/Aurora.Music/pull/5) contributed by [OpportunityLiu](https://github.com/OpportunityLiu):\r\n\r\n" +
                           "\t1. Now app can automatically load lrc from current music file's folder.\r\n" +
                            "\t2. All the area of the lyric window and small window are draggable.\r\n" +
                            "\t3. And update a few layouts.\r\n" +
                            "* **Improve**: Bugs fixed.\r\n";
