...
namespace Aurora.Shared.Controls
{
    ...
    public class PulltoRefresh : ContentControl
    {
        ...
        public ScrollViewer m_scroller;
        ...
        /// <summary>
        /// Creates a new instance of <see cref="PulltoRefresh"/>
        /// </summary>
        ...
        private void AddOverpanSuppressors()
        {
            if (m_overpanSuppressorHead == null)
            {
                ...
                if (m_scrollerContent is Panel panel)
                {
        ...
        public static readonly DependencyProperty PullThresholdProperty =
            DependencyProperty.Register("PullThreshold", typeof(double), typeof(PulltoRefresh), new PropertyMetadata(double.NaN));
        ...
        public static readonly DependencyProperty RefreshCommandProperty =
            DependencyProperty.Register("RefreshCommand", typeof(ICommand), typeof(PulltoRefresh), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty RefreshIndicatorContentProperty =
            DependencyProperty.Register("RefreshIndicatorContent", typeof(object), typeof(PulltoRefresh), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty AutoRefreshProperty =
            DependencyProperty.Register("AutoRefresh", typeof(bool), typeof(PulltoRefresh), new PropertyMetadata(true));
        #endregion
    }
