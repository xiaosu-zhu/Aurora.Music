 ...
 * 
 */
namespace Aurora.Shared.PinYinLib.Model
{
    public class PinyinUnit
    {
        //Whether Pinyin
        public bool IsPinyin { get; set; }
         ...
         */
        private List<PinyinBaseUnit> PinyinBaseUnitIndex { get; set; }

        public PinyinUnit()
        {
            IsPinyin = false;
            StartPosition = -1;
            PinyinBaseUnitIndex = new List<PinyinBaseUnit>();
        }
    }
}
